...
import Controller, { BrowserRouterController, i18n } from 'react-router-controller';
import nopage from './view/nopage';

Controller.set({
  readViewFile(viewId, controllerId, firstLoad) {
    //view可以异步载入
    return import(`./view/${controllerId}/${viewId}/index.jsx`).then(component => {
...
export default function container(props) {
  ...
  return <BrowserRouterController basename={process.env.PREFIX_URL} hot={props.hot} />;
}
